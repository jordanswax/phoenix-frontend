...
const newServerJs = (config, options) => {
...
const newPackageJson = (packageJson) => {
    ...
    (_a = newPackageJSON.dependencies)['firebase-admin'] || (_a['firebase-admin'] = FIREBASE_ADMIN_VERSION);
    (_b = newPackageJSON.dependencies)['firebase-functions'] || (_b['firebase-functions'] = FIREBASE_FUNCTIONS_VERSION);
    (_c = newPackageJSON.dependencies)['cookie'] || (_c['cookie'] = COOKIE_VERSION);
    (_d = newPackageJSON.dependencies)['lru-cache'] || (_d['lru-cache'] = LRU_CACHE_VERSION);
    newPackageJSON.engines || (newPackageJSON.engines = {});
    (_e = newPackageJSON.engines).node || (_e.node = NODE_VERSION);
