...
exports.newPackageJson = exports.newServerJs = void 0;
const path_1 = require("path");
const fs_1 = require("fs");
const { readdir, readFile } = fs_1.promises;
const newServerJs = (config, options, importSnippet) => {
...
exports.newServerJs = newServerJs;
...
const newPackageJson = (packageJson, getProjectPath) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    // Unclear if this is needed at this point
    const nodeModulesPath = getProjectPath('.output', 'server', 'node_modules');
    const directories = (0, fs_1.existsSync)(nodeModulesPath) ? yield readdir(nodeModulesPath) : [];
    const staticDepsArray = yield Promise.all(directories.map((directory) => __awaiter(void 0, void 0, void 0, function* () {
        const packageJsonBuffer = yield readFile((0, path_1.join)(nodeModulesPath, directory, 'package.json'));
    ...
    newPackageJSON.dependencies || (newPackageJSON.dependencies = {});
    newPackageJSON.dependencies = Object.assign(Object.assign(Object.assign({}, newPackageJSON.dependencies), staticDeps), { 'firebase-admin': FIREBASE_ADMIN_VERSION, 'firebase-functions': FIREBASE_FUNCTIONS_VERSION, 'cookie': COOKIE_VERSION, 'lru-cache': LRU_CACHE_VERSION });
    newPackageJSON.engines || (newPackageJSON.engines = {});
    (_a = newPackageJSON.engines).node || (_a.node = NODE_VERSION);
    return JSON.stringify(newPackageJSON, null, 2);
});
exports.newPackageJson = newPackageJson;
